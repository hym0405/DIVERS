...
color_database('matlab blue')=[0 0.4470 0.7410];
color_database('matlab orange')=[0.8500 0.3250 0.0980];
color_database('matlab yellow')=[0.9290 0.6940 0.1250];
color_database('matlab purple')=[0.4940 0.1840 0.5560];
color_database('matlab green')= [0.4660 0.6740 0.1880];
color_database('matlab light blue')=[0.3010 0.7450 0.9330];
color_database('matlab maroon')=[0.6350 0.0780 0.1840];
color_database('neon blue')=[.2222 .7778 1.0000];
color_database('neon purple')=[.5556 .4444 1.0000];
color_database('neon red')=[1.0000 .3333 .6667];
color_database('neon orange')=[1.000 .5556 .4444];
color_database('neon green')=[.6667 .8333 .4000];
color_database('neon teal')=[0 .7778 .6111];
